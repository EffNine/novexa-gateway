...
// NVIDIA NIM exposes an OpenAI-compatible API at /v1/chat/completions,
...
func (p *Provider) ChatCompletionStream(ctx context.Context, req *apitypes.ChatCompletionRequest) (
...
// ListModels returns available models from the NVIDIA NIM API.
...
// GetPricing returns a static pricing map for commonly used NVIDIA NIM models.
...
// SupportsModel returns true for all models since NIM routes by model ID.
