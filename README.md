...
- **Model Prober** — Minimal chat probes across all registered providers (configurable) to hide unreachable catalog entries; runs on startup/redeploy, then every `12h` by default
